...
import { ArrowLeft, User, Shield, Phone, Key, Eye, EyeOff } from "lucide-react"
          ...
          <CardHeader className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <div>
                ...
                }`}>Patient Login</CardTitle>
                <CardDescription className={
                  theme === 'dark' ? 'text-zinc-400' : 'text-zinc-600'
                }>Fayda ID Authentication Required</CardDescription>
              </div>
            </div>
          </CardHeader>
