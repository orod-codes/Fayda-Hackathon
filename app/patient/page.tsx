              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-zinc-100">Patient Name</p>
                      <p className="text-sm text-zinc-400">FIN: 123456789</p>
                    </div>
                  </div>
                  ...
                  <Card className="bg-zinc-800/50 border-zinc-700">
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-zinc-100">120/80</p>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-zinc-400">Heart Rate (bpm)</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Card className="bg-zinc-800/50 border-zinc-700 hover:bg-zinc-800/70 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-6 text-center">
                      ...
                      <h3 className="font-semibold text-zinc-100">Health Devices</h3>
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-800/50 border-zinc-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-zinc-400">Your complete medical records from all hospitals</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        <div key={record.id} className="border border-zinc-700 rounded-lg p-4">
                          <div className="flex justify-between items-start mb-3">
                            <div>
                              ...
                              <p className="text-sm text-zinc-400">{record.doctor} - {record.hospital}</p>
                            </div>
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-800/50 border-zinc-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-zinc-400">AI-powered medication reminders and tracking</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {medications.map((med) => (
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-800/50 border-zinc-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-zinc-400">Upload and manage your medical documents</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="border-2 border-dashed border-zinc-600 rounded-lg p-8 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-zinc-100 mb-2">Upload Medical Documents</h3>
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-800/50 border-zinc-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-zinc-400">Schedule and manage video appointments with doctors</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-800/50 border-zinc-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-zinc-400">Connect and manage wearable health devices</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
